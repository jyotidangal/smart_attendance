...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\hp\\Documents\Smart_Attendance_System\Images_GUI\bgReg.jpg")
           ...
           # messagebox.showinfo("Successfully","Successfully Register!")
            try:
                ...
                if row!=None:
                    ...
                    mycursor.execute("insert into admin values(%s,%s,%s,%s,%s,%s,%s)",(
                    self.var_fname.get(),
                    self.var_lname.get(),
                    self.var_cnum.get(),
                    self.var_email.get(),
