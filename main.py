...
# This part is image labels setting start 
        ...
        #title section
        title_lb1 = Label(bg_img,text=" Smart Attendance System",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1366,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\hp\Documents\Smart_Attendance_System\Images_GUI\std1.jpg")
        ...
        det_img_btn=Image.open(r"C:\Users\hp\Documents\Smart_Attendance_System\Images_GUI\det1.jpg")
        ...
        att_img_btn=Image.open(r"C:\Users\hp\Documents\Smart_Attendance_System\Images_GUI\att.jpg")
        ...
        # Start below buttons.........
         # Train   button 4
        tra_img_btn=Image.open(r"C:\Users\hp\Documents\Smart_Attendance_System\Images_GUI\tra1.jpg")
        ...
        # Photo   button 5
        pho_img_btn=Image.open(r"C:\Users\hp\Documents\Smart_Attendance_System\Images_GUI\qr1.png")
        ...
        pho_b1.place(x=250,y=330,width=180,height=180)
        pho_b1_1 = Button(bg_img,command=self.open_img,text="Photos",cursor="hand2",font=("times new roman",15,"bold"),bg="white",fg="navyblue")
        pho_b1_1.place(x=250,y=510,width=180,height=45)
        
        # Developers   button 6
        dev_img_btn=Image.open(r"C:\Users\hp\Documents\Smart_Attendance_System\Images_GUI\dev.jpg")
        ...
        # exit   button 
        exi_img_btn=Image.open(r"C:\Users\hp\Documents\Smart_Attendance_System\Images_GUI\exi.jpg")
